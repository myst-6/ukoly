/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 181dd8af3d1612bd930f2e894269b7df)
// Runtime types generated with workerd@1.20250617.0 2025-07-18 
declare namespace Cloudflare {
	interface Env {
		ENVIRONMENT: "development" | "local";
		RATE_LIMITER: DurableObjectNamespace<import("./src/index").RateLimiter>;
		ExecutionSandbox: DurableObjectNamespace<import("./src/index").ExecutionSandbox>;
		RustSandbox: DurableObjectNamespace<import("./src/index").RustSandbox>;
		JavaSandbox: DurableObjectNamespace<import("./src/index").JavaSandbox>;
