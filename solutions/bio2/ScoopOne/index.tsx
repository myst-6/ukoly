...
export const ScoopOne = () => {
  return (
    <>
      ...
      <SList>
        <SText>
          The package is at $i$ unlocked, and lock $i$ gets added.
        </SText>
        <SText>
          The package is at $j$ locked with a lock other than $j$, and lock $j$ gets added
        </SText>
        <SText>
          The package is at $i$ locked with lock $i$ and $j$, and lock $i$ gets removed.
        </SText>
        <SText>
      ...
      <SText>
        In this case, the input is a tree with $2$ vertices, and $1$ edge, with height $1$. The answer is thus $6 \cdot 1 - 3 \cdot 1 = 3$.
      </SText>
      <STitle>Code</STitle>
