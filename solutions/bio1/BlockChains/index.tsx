...
export const BlockChains = () => {
    return (
        <>
            ...
            <SList>
                <SText> 1. Generate all possible permutations of the remaining letters that could follow the prefix p.</SText>
                <SText> 2. Check each permutation to see if it contains any three letters in alphabetical order. </SText>
                <SText> 3. Count and return the number of permutations that are valid. </SText>
            </SList>
            <SText>
