...
export const OnTheRightTrack = () => {
  return (
    <>
      <STitle>Idea</STitle>
      <SText>
        This is a quite straightforward implementation problem, and with the small-ish n $(n {'<'}= 10,000)$, a straightforward simulation is in order.
      </SText>
      ...
      <SText>
        ...
        With this <SCode>Stop</SCode> class, tracking the train's movement is easy, and we can do this using a map which will store each stop indexed by it's character($A, B$, etc).
        A helpful tip, when you use a map with a custom struct/class, be sure to implement a constructor which takes no parameters (which can be empty).
        ...
        An unordered_map will require you to create an entire hash function for your class, which is considerably more tedious. 
      </SText>
