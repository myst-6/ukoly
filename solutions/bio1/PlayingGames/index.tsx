...
export const PlayingGames = () => {
  return (
    <>
      ...
      <SText>
        We can brute force every possible first die, as we know the first pair of dice have a maximum value of $8$, the maximum possible combination is $16$,
        and we know that the largest face of at least one of the second pair is less than or equal to
        $8$, as the largest face of both cannot be greater than $8$, as this would mean their sum is more than or equal to $18$, which is too big.
