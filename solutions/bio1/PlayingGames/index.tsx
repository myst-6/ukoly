...
export const PlayingGames = () => {
  return (
    <>
    <STitle children={undefined}>Observation</STitle>
    <SText children={undefined}>
    ...
    <STitle children={undefined}>Brute Force</STitle>
    <SText children={undefined}>
    ...
    <STitle children={undefined}>Solution</STitle>
    <SText children={undefined}>
    ...
    <STitle children={undefined}>Code</STitle>
