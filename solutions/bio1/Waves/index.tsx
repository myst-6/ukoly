...
export const Waves = () => {
    return (
        ...
        <SText>
          ...
          (only $9 \times 9$) and the number of pebbles is only $\leq 5$.
        ...
        <SList>
          <SText>
            If the distance between the $x$-coordinates of the pebble and the cell
        ...
        <SList>
          <SText>
            The only caveat is the fact that waves can reflect off the banks.
          ...
          <SList>
            <SText>
              The cell's $x$-coordinate is between the right bank the pebble's $x$-coordinate.
              This case is solved similarly to the previous one.
            </SText>
          </SList>
          <SList>
            <SText>
              Both the cell and the pebble are in between the banks,
        ...
        <SText>
          ...
          iterate through all the pebbles and add up all their effects on the depth this cell.
          If the total depth is negative, output <SCode>o</SCode>. If the total depth is positive, output <SCode>*</SCode>.
